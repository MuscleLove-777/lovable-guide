...
def run(config, prompts=None):
    ...
    # Gemini がプロンプト例の "lovable 使い方" をオウム返しして同一記事量産が発生。
    ...
    try:
        ...
        from seo_optimizer import LovableSEOOptimizer
        ...
        optimizer = LovableSEOOptimizer(config)
    ...
    try:
        from site_generator import LovableSiteGenerator
        site_gen = LovableSiteGenerator(config)
        site_gen.build_site()
